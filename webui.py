...
<style>
    ...
    .nav-item {{ font-size: 25px; color: #2e7d32; font-weight: 600; cursor: pointer; transition: color 0.3s ease; }}
...
if st.session_state.page_now == 'me':
    ...
    with col_B:
        ...
        with col_r: streaming_mode = st.toggle("streaming_mode", key="streaming_mode_toggle") 
